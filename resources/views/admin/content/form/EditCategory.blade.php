...
<div class="uk-child-width-expand@s uk-grid-match" uk-grid>
	<div>
		<div class="uk-card uk-card-default uk-card-hover uk-card-body">
			...
			<form action="{{ route('category.update', $id) }}" method="post" class="uk-form-horizontal uk-margin-large">
				{{ csrf_field() }}
				<input name="_method" type="hidden" value="PATCH">
				<div class="uk-margin">
			        <label class="uk-form-label" for="form-horizontal-text">Category Name</label>
			        <div class="uk-form-controls">
			            <input class="uk-input" id="form-horizontal-text" name="category_name" type="text" value="{{ $category->category_name }}">
			        </div>
			    </div>
			    <div class="uk-margin">
