...
<div class="uk-child-width-expand@s uk-grid-match" uk-grid>
	<div>
		<div class="uk-card uk-card-default uk-card-hover uk-card-body">
			...
			<form action="{{ url('/admin/product') }}" method="post" class="uk-form-horizontal uk-margin-large" enctype="multipart/form-data">
				{{ csrf_field() }}
				<div class="uk-margin">
			        <label class="uk-form-label" for="form-horizontal-text">Product Name</label>
			        <div class="uk-form-controls">
			            <input class="uk-input" id="form-horizontal-text" name="product_name" type="text" placeholder="Product Name">
			        </div>
			    </div>
				...
				<div class="uk-margin">
			        ...
			        <div class="uk-form-controls">
			            <input class="uk-input" id="form-horizontal-text" name="price" type="text" placeholder="Product Price">
			        </div>
			    </div>
			    ...
			    <div class="uk-margin">
			        ...
			        <div class="uk-form-controls">
			            <input class="uk-input" id="form-horizontal-text" name="qty" type="text" placeholder="Product Quantity">
			        </div>
			    </div>
			    ...
			    <div class="uk-margin">
			        ...
			        <div class="uk-margin">
			            <textarea class="uk-textarea" rows="5" name="description" placeholder="Product Description"></textarea>
			        </div>
			    </div>

			    <div class="uk-margin">
			    	<button type="submit" class="uk-button uk-button-default uk-width-1-1 uk-margin-small-bottom">Add Product</button>
			    </div>
			</form>
		</div>
	</div>
